...
import {  getHistoricalData, getStats, getTrades, getTradesSummary, saveJournalEntry, uploadCSVBulk } from '../controllers/trade.controller.js';
...
router.post("/getStats",verifyUser, getStats);
